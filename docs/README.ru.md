...
Попросите Codex установить этот репозиторий или запустите его установщик Skills:
...
После установки откройте новый диалог Codex и попросите: «Используй ChongPlus для генерации кинематографичного горного пейзажа на рассвете». При первом использовании будет запрошен и локально сохранен API Key; переменная окружения не нужна.
